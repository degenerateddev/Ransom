...
LRESULT CALLBACK ScreenConfusion(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam) {
	switch (Msg)
	{
	case WM_CREATE:
	{
...
int APIENTRY WinMain(HINSTANCE Inst, HINSTANCE Prev, LPSTR Cmd, int showcmd) {
	...
	WNDCLASS wndClass = { 0, ScreenConfusion, 0,0, Inst, 0, LoadCursorW(0, IDC_ARROW), 0, 0, L"Ransom.exe" };
